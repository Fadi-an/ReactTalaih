            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 other-content">
                        ...
                        <iframe className="embed-responsive-item ytvideo2" src="https://www.youtube.com/embed/g1jSnBZfM0k" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                    </div>
                    <div className="col-lg-6 other-content">
